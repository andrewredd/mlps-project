...
# insert porter stemmer function
...
# could be replaced with a more comprehensive list in tidy text
# could be replaced with a functional stop word list
...
# potentially remove and let tfidf 
...
# potentially dump as a dataset to compare tfidf transformation vs count frequency

dtm_final_non_tfidf = create_dtm(it_train, vectorizer)

# drop low values from tfidf
